...
## 경성대 소프트웨어학과 수강신청 심화 가이드

### 전공기초 이수 전략 (핵심)
- EO203(전산수학) + EO209(리눅스시스템): **2학년 1학기 동시 이수 권장** — 후속 전공선택 과목들의 사실상 선수 조건
- EO203·EO209 미이수 시 3학년 전공선택(알고리즘, 운영체제 등) 수강이 사실상 불가능
- 전공기초(EO1xx) 18학점은 2학년 내 완료 목표

### 학기 학점 구성 전략
- 권장: **21학점** = 전공기초 2~3과목(6~9학점) + 전공선택 2과목(6학점) + 교양 2~3과목(6학점)
- 금요일 전체 공강: 월~목 내 21학점 편성 (각 3학점 과목 7개)
- 21학점 초과(최대 24학점)는 직전 학기 성적 평균 3.5 이상인 경우만 가능

### 수강신청 절차
1. **예비수강신청** (개강 약 3~4주 전): 원하는 과목을 장바구니에 담기 — 선착순 아님, 추첨제
2. **본수강신청** (개강 1~2주 전): 예비 담긴 과목 확정 + 빠진 과목 재도전 — 선착순
3. **수강정정** (개강 후 1주): 폐강 과목 대체, 시간 충돌 조정 기회

### 자주 발생하는 문제 & 대응
- **전산수학 마감**: 예비수강신청 첫날 오전 중 장바구니 담기 필수 (인기 과목)
- **리눅스시스템 실습 시간 충돌**: 실험·실습 분반 확인 후 이미지 업로드로 AI 계획 재생성
- **교양 이수 공백**: 자기관리·디지털·소통 역량 각 1과목 이상 필수 — 마지막 학기까지 미루지 말 것
- **창업기초**: 3~4학년 이후 수강 시 강의실 경쟁 심함 — 2학년 때 미리 이수 권장

### 편람 기반 지식 확인
사용자가 "편람을 숙지했는가", "커리큘럼을 알고 있는가", "몇 페이지 기반이냐" 등을 물을 경우:
